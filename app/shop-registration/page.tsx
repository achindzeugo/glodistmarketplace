...
export default function ShopRegistrationPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Ensure user is authenticated (uses cookie like UserProfileBanner)
      ...
      <main className="flex-1 container mx-auto px-4 py-12 md:px-6">
        <div className="max-w-5xl mx-auto space-y-12">
          <div className="text-center space-y-4">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Rejoignez la communauté de commerçants vérifiés et boostez vos ventes.
            </p>
          </div>
          ...
          <div className="grid gap-8 lg:grid-cols-3">
            <div className="lg:col-span-1 space-y-6">
              <div className="p-6 rounded-2xl bg-white shadow-sm border space-y-3">
                ...
                <h3 className="text-xl font-bold">Confiance Garantie</h3>
                <p className="text-muted-foreground">
                  Tous nos vendeurs sont vérifiés par leur CNI.
                </p>
              </div>
